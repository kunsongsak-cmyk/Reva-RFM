...
export const OutcomeModal: React.FC<OutcomeModalProps> = ({
  ...
  const [outcomeText, setOutcomeText] = useState('Interested in Oligio X');
  const [notes, setNotes] = useState('Khun Ananya mentioned schedule opening next Thursday. Send Oligio X recall flyer with afternoon tea reservation voucher...');
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[12px] text-[#45464d]">
                Target: {patient.name} ({patient.nickname}) • HN: {patient.hn}
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="p-3 rounded-lg bg-[#eff4ff] flex items-start gap-2 text-[12px]">
            ...
            <p className="text-[#45464d] leading-relaxed">
              <strong className="text-[#0b1c30]">Smart Flow:</strong> Selecting <span className="font-semibold text-[#006a61]">"Interested"</span> triggers instant slot reservations. If changing to <span className="font-semibold text-[#0b1c30]">"Contact Later"</span>, calendar reschedule picker becomes mandatory.
            </p>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Record interaction notes, objections, preferences..."
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              >
                <option value="13:00 - 15:00 (Preferred)">13:00 - 15:00 (Preferred)</option>
